...
const EmployeesPage = ({value, setValue, user}) => {
	...
	const fetchEmployees = async () => {
	    const { data } = await axios.get(
	      "https://httpservercontrol.mostspecialdelivery.tech/api/employees/?format=json"
	    )
	    setEmployees(data)
	}
	const addEmployee = async (e) => {
		...
		const response = await axios.post('https://httpservercontrol.mostspecialdelivery.tech/api/employees/', data)
		setOpen(false)
		setName("")
		setPayment("")
		setQuantity(0)
